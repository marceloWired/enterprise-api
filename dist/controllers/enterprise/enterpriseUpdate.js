"use strict";Object.defineProperty(exports, "__esModule", {value: true});var _enterprises = require('../../services/enterprises');
 ...
 const enterpriseUpdateController = {
  update: async (req, res) => {
    try {
      ...
      const result = await _enterprises.enterpriseServices.update(enterpriseData, id)
...
}; exports.enterpriseUpdateController = enterpriseUpdateController
